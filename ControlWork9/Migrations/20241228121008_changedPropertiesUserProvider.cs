...
{
    /// <inheritdoc />
    public partial class changedPropertiesUserProvider : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalAccount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserServices_ServiceProviders_ServiceProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserServices_ServiceProviderId",
                table: "UserServices",
